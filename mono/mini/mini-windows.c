...
{
	// tdelort : removed these seh handlers since they are not implemented in ARM or ARM64
	// TODO : fix exceptions
#if !defined(MONO_CROSS_COMPILE) && !defined(TARGET_ARM) && !defined(TARGET_ARM64)
	win32_seh_init();
